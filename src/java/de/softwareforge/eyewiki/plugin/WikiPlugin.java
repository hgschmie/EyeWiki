...
public interface WikiPlugin
{
     ...
     * @param params A Map which contains key-value pairs.  Any parameter that the user has specified on the wiki page will contain
     *        String-String parameters, but it is possible that at some future date, eyeWiki will give you other things that are
     *        not Strings.
     *
