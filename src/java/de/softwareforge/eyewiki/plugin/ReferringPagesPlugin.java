...
/**
 * Displays the pages referring to the current page. Parameters: <BR> max: How many items to show.<BR> extras: How to announce
 * extras.<BR> From AbstractReferralPlugin:<BR> separator: How to separate generated links; default is a wikitext line break,
 * producing a vertical list.<BR> maxwidth: maximum width, in chars, of generated links.
 *
        ...
        implements WikiPlugin
{
    ...
    /**
     * Creates a new ReferringPagesPlugin object.
     *
            ...
            throws PluginException
    {
        ...
        if (page != null)
        {
            ...
            {
                log.debug("Fetching referring pages for " + context.getPage().getName() + " with a max of " + items);
            }
