        ...
        extends DavItem
{
    ...
    protected Collection getCommonProperties()
    {
        ...
        set.add(new Element("getlastmodified", m_davns).setText(DateFormatUtils.ISO_DATETIME_TIME_ZONE_FORMAT.format(
                    m_page.getLastModified())));
    ...
    {
        return m_engine.getURL(WikiContext.NONE, "dav/raw/" + m_page.getName() + ".txt", null, true);
    }
}
