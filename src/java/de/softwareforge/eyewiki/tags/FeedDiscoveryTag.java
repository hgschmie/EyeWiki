        ...
        extends WikiTagBase
{
            ...
            throws IOException
    {
        ...
        if (rssURL != null)
        {
            ...
            pageContext.getOut().print("<link rel=\"alternate\" type=\"application/rss+xml\" title=\"RSS feed for the entire site.\" href=\""
                + rssURL + "\" />\n");
            pageContext.getOut().print("<link rel=\"alternate\" type=\"application/rss+xml\" title=\"RSS feed for page " + siteName
                + ".\" href=\"" + rssFeedURL + "\" />\n");
            ...
            if ("true".equals(page.getAttribute(WeblogPlugin.ATTR_ISWEBLOG)))
            {
                ...
                pageContext.getOut().print("<link rel=\"service.feed\" type=\"application/atom+xml\" title=\"" + siteName
                    + "\" href=\"" + atomFeedURL + "\" />\n");
            }
        }
