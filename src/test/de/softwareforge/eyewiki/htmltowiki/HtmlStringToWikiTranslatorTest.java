        ...
        extends TestCase
{
            ...
            throws Exception
    {
        ...
        assertEquals(
            "a\n| erste\n",
            html2wiki.translate(
                "a <table border=\"1\"> <tbody><tr> <td> erste</td> </tr> </tbody> </table>"));
        ...
        assertEquals(
            "Wilma: ''Ich m�chte hier mal in aller Deutlichkeit sagen! ''",
            html2wiki.translate(
                "Wilma: <i>Ich             m�chte hier\nmal in aller\nDeutlichkeit sagen! </i>"));
        ...
        assertEquals(
            "| Name: [Christian|ChristianS] \\\\ Geschicklichkeit: 2 \\\\ Hang zu perversen Sexorgien. Jongliert mit Worten und K�pfen. \\\\ [Berian Nachtschleicher|Berian] \\\\ [XLerul] \\\\ [Effifot Erif]\n",
            html2wiki.translate(
        ...
        assertEquals(
            "%(( text-align: center; display: block; )Hello \\\\World!%)",
            html2wiki.translate("<div style=\"text-align: center;\">Hello<br>World!</div>"));

        assertEquals(
            "__%(( text-align: center; display: block; )Hello \\\\World!%)__",
            html2wiki.translate(
                "<span style=\"font-weight: bold; text-align: center;\">Hello<br>World!</span>"));
        ...
        assertEquals(
            "[{Image src=\'AbenteuerQuilpins/Quilpins.jpg\' align=\'left\'}]",
            html2wiki.translate(
        ...
        assertEquals(
            "{{{[{Test\\\\Hello World!}]}}}", html2wiki.translate("{{{[{Test\\\\Hello World!}]}}}"));
        ...
        assertEquals(
            "Diese Karte{{{ kann }}} von",
            html2wiki.translate(
                "Diese Karte<span style=\"font-family: courier new,courier,mono;\"> kann </span> von"));
        ...
        assertEquals(
            "%(( color: rgb(255, 0, 0); )Und niemand wird sie sehen%), die",
            html2wiki.translate(
                "<span style=\"color: rgb(255, 0, 0);\">Und niemand wird sie sehen</span>, die"));
