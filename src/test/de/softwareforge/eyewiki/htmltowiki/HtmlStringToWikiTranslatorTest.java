 ...
 *
 * @author <a href="sbaltes@gmx.com">Sebastian Baltes</a>
 */
public class HtmlStringToWikiTranslatorTest
        extends TestCase
{
    /**
     * Creates a new TestHtmlStringToWikiTranslator object.
     *
            ...
            throws Exception
    {
        ...
        assertEquals("Dies ist __bold__, ''italic'' und __''both''__.",
            html2wiki.translate(
        ...
        assertEquals("Wilma: ''Ich m�chte hier mal in aller Deutlichkeit sagen! ''",
            html2wiki.translate("Wilma: <i>Ich             m�chte hier\nmal in aller\nDeutlichkeit sagen! </i>"));

        assertEquals("| 3. Rang | Name des Helden, den der Bogen t�ten sollte.\n"
            + "| F�higkeit | Bonus auf die Initiative von 1\n\n",
            html2wiki.translate(
                "<table class=\"wikitable\" border=\"1\"> <tbody><tr><td> 3. Rang</td><td> Name des Helden, den der Bogen t�ten sollte.</td></tr> <tr><td> F�higkeit</td><td> Bonus auf die Initiative von 1</td></tr> </tbody></table> </p><p>"));
        ...
        assertEquals("|| Throalisches Jahr || Ereignis\n"
            ...
            html2wiki.translate(
                "<table class=\"wikitable\" border=\"1\"> <tbody><tr><th> Throalisches Jahr </th><th> Ereignis</th></tr> <tr><td> 100 v. TH</td><td> Elianer Messias �bersetzt die tausendj�hrigen B�cher von Harrow.</td></tr> <tr><td> 50 v. TH</td><td> Gr�ndung Nehr?eshams und der ewigen Bibliothek.</td></tr> </tbody></table>"));
        ...
        assertEquals("| Name: [Christian|ChristianS] \\\\ Geschicklichkeit: 2 \\\\ Hang zu perversen Sexorgien. Jongliert mit Worten und K�pfen. \\\\ [Berian Nachtschleicher|Berian] \\\\ [XLerul] \\\\ [Effifot Erif]\n",
            html2wiki.translate(
        ...
        assertEquals("\n\n\\\\__Willkommen__ \\\\ \\\\ Und niemand wird sie sehen \\\\ Eine Page ... \\\\ \\\\\n\nAls Unterthema\n\n",
            html2wiki.translate(
                "<p> <br><b>Willkommen</b> <br> <br> Und niemand wird sie sehen <br> Eine Page ... <br> <br> </p><p> Als Unterthema</p><p>"));
        ...
        assertEquals("\n* eins\n* zwei\n* drei\n\n# eins\n# zwei\n# drei\n\n* ober\n\n** unter\n\n*** unter-unter\n\n**** unter-unter-unter\n\n# ober\n\n## unter\n\n### unter-unter\n\n#### unter-unter-unter\n#### unter-unter-unter\n### unter-unter\n\n* ober\n\n*# unter\n\n*## unter\n\n# ober\n\n#* unter\n\n#** unter\n\n",
            html2wiki.translate(
                "<ul> <li> eins </li> <li> zwei </li> <li> drei </li> </ul> <p> </p><ol> <li> eins </li> <li> zwei </li> <li> drei </li> </ol> <p></p><p> </p><ul> <li> ober </li> <ul> <li> unter </li> <ul> <li> unter-unter </li> <ul> <li> unter-unter-unter </li> </ul> </ul> </ul> </ul> <p></p><p> </p><ol> <li> ober </li> <ol> <li> unter </li> <ol> <li> unter-unter </li> <ol> <li> unter-unter-unter </li> <li> unter-unter-unter </li> </ol> <li> unter-unter </li> </ol> </ol> </ol> <p></p><p> </p><p> </p><ul> <li> ober </li> <ol> <li> unter </li> <ol> <li> unter </li> </ol> </ol> </ul> <p></p><p> </p><p> </p><ol> <li> ober </li> <ul> <li> unter </li> <ul> <li> unter </li> </ul> </ul> </ol> <p></p><p> </p>"));
        ...
        assertEquals("__%(( text-align: center; display: block; )Hello \\\\World!%)__",
            html2wiki.translate("<span style=\"font-weight: bold; text-align: center;\">Hello<br>World!</span>"));

        assertEquals("[{Image src='Homunkulus/homunculus4.jpg' align='left'}]",
            html2wiki.translate(
        ...
        assertEquals("[{Image src=\'AbenteuerQuilpins/Quilpins.jpg\' caption=\'Testing Image\' style=\'font-size: 120%; color: green;\'}]",
        ...
        assertEquals("[{Image src=\'http://opi.yahoo.com/online?u=YahooUser1234&m=g&t=2\' link=\'http://edit.yahoo.com/config/send_webmesg?.target=YahooUser1234&.src=pg\'}]",
        ...
        assertEquals("[{Image src=\'homunculus4.jpg\' align=\'left\' height=\'100px\' width=\'100px\' alt=\'alt text\' caption=\'caption text\' link=\'http://google.de\' border=\'1\'}]",
            html2wiki.translate("<table class=\"imageplugin\" align=\"left\" border=\"0\"> \r\n"
        ...
        assertEquals("[ThisPageDoesNotExist] ",
            html2wiki.translate("<u>ThisPageDoesNotExist</u><a href=\"Edit.jsp?page=ThisPageDoesNotExist\">?</a>"));

        assertEquals("[/eyeWiki/wysiwyg/FCKeditor/editor/images/smiley/msn/sad_smile.gif] ",
            html2wiki.translate("<img src=\"/eyeWiki/wysiwyg/FCKeditor/editor/images/smiley/msn/sad_smile.gif\" alt=\"\"/>"));
        ...
        assertEquals("{{{[{Test\\\\Hello World!}]}}}{{{[{Test\\\\\\\\Hello World!}]}}}[{Test\n\nHello World!}][{Test\n\nHello World!}]",
            html2wiki.translate(
        ...
        assertEquals("\n* Diese Karte kann von jedem editiert und um neue Links erweitert werden. \\\\Klickt einfach unten neben der Karte auf {{{[edit]}}}\n",
            html2wiki.translate(
                "<ul><li> Diese Karte kann von jedem editiert und um neue Links erweitert werden.<br>Klickt einfach unten neben der Karte auf <span style=\"font-family: monospace;\">[edit]</span></li></ul>"));

        assertEquals("\n* Diese Karte kann von jedem editiert und um neue Links erweitert werden. \\\\Klickt einfach unten neben der Karte auf {{{[edit]}}}\n",
            html2wiki.translate(
                "<ul><li> Diese Karte kann von jedem editiert und um neue Links erweitert werden.<br>Klickt einfach unten neben der Karte auf <span style=\"font-family: monospace;\">[edit]</span></li></ul>"));

        assertEquals("Diese Karte{{{ kann }}} von",
            html2wiki.translate("Diese Karte<span style=\"font-family: courier new,courier,mono;\"> kann </span> von"));

        assertEquals("Fahrt einfac{{{h mit\u00A0\u00A0 \n der \u00A0 Maus}}} drueber",
            html2wiki.translate(
                "Fahrt einfac<span style=\"font-family: monospace;\">h mit&nbsp;&nbsp; <br> der &nbsp; Maus</span> drueber"));
     ...
     * @param b DOCUMENT ME!
     *
     * @throws AssertionFailedError DOCUMENT ME!
     */
