  ...
  <wiki:UserCheck status="unvalidated">
    <form action="<wiki:Variable var="baseURL"/>Login.jsp" accept-charset="UTF-8" method="post" >
      ...
      <table class="loginbox">
        <tr><td class="loginbox"><input type="text" name="uid" size="16" value="<wiki:UserCheck status="known"><wiki:UserName /></wiki:UserCheck>" /></td></tr>
        <tr><td class="loginboxmsg">User name</td></tr>
        <tr><td class="loginbox"><input type="password" name="passwd" size="16" /></td></tr>
        <tr><td class="loginboxmsg">Password</td></tr>
        <tr><td class="loginbox"><input type="submit" name="action" value="login" /></td></tr>
      </table>
    </form>
  </wiki:UserCheck>
